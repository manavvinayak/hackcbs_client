            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-4">
                  Click on the "Get Started" button in the navigation bar to start practicing. 
                  This is where you'll manage all your practice sessions.
                </p>
                <ul className="text-gray-600 space-y-2">
                  <li className="flex items-center">
                    <span className="w-2 h-2 bg-purple-700 rounded-full mr-3"></span>
                    View your practice sessions
                  </li>
                  <li className="flex items-center">
                    <span className="w-2 h-2 bg-purple-700 rounded-full mr-3"></span>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-4">
                  ...
                  Each type focuses on different skills and experiences.
                </p>
