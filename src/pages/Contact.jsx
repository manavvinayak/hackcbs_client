        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-green-600 to-blue-600 text-white py-3 px-6 rounded-lg font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@interviewpro.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Click the chat icon on any page</p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <details className="group">
                  ...
                  <p className="mt-4 text-gray-600 px-4">
                    Our AI analysis is highly accurate, using advanced computer vision and machine learning models trained on thousands of interview scenarios. The system provides reliable feedback on eye contact, facial expressions, and body language.
                  </p>
                </details>
                ...
                <details className="group">
                  ...
                  <p className="mt-4 text-gray-600 px-4">
                    Absolutely! InterviewPro supports technical interviews, HR questions, behavioral interviews, and more. You can also upload your resume for personalized questions based on your experience.
                  </p>
                </details>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white text-center">
              ...
              <p className="text-blue-100 mb-6">Stay updated with tips and new features</p>
